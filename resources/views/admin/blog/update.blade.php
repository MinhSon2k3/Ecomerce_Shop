                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class=" mb-0 bc-title"><b>Cập nhật Blog</b> </h3>
                                        ...
                                        <form class="admin-form"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title"
                                                    placeholder="Nhập Tiêu đề" value="{{ $blog->title }}">
                                                @error('title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="details" class="form-control text-editor" rows="5" placeholder="Nhập chi tiết">{{ $blog->description }}</textarea>
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <script>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tags" class="tags" id="tags"
                                                    placeholder="Nhập thẻ Tag" value="{{ $blog->tags }}">
                                                @error('tags')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_keywords" class="tags" id="meta_keywords"
                                                    placeholder="Nhập Meta Keywords" value="{{ $blog->meta_keyword }}">
                                                @error('meta_keywords')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" id="meta_description" class="form-control" rows="5"
                                                    placeholder="Nhập Meta Description">{{ $blog->meta_description }}</textarea>
