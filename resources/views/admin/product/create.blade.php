                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group position-relative ">
                                    <label class="file">
                                        <input type="file" accept="image/*" class="upload-photo" name="featured_image"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description" id="sort_details" class="form-control"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="tags" class="tags" id="tags" placeholder="Tags" value="">
                                    @error('tags')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="meta_description" id="meta_description" class="form-control"
                                        rows="5" placeholder="Enter Meta Description"></textarea>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="current_price" name="current_price" class="form-control"
                                            placeholder="Enter Current Price" min="1" step="0.1" value="">
                                        @error('current_price')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="previous_price" name="previous_price"
                                            class="form-control" placeholder="Enter Previous Price" min="1" step="0.1"
                                            value="">
