                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card-body">
                                <div class="product-category"><a
                                        href="/shop/category/{{ $categories1->slug }}">{{ $categories1->name }}</a>
                                </div>
                ...
                <div class="popular-category-slider owl-carousel">
                    ...
                    <div class="slider-item">
                        <div class="product-card">
                            ...
                            <div class="product-card-body">
                                <div class="product-category"><a
                                        href="/shop/category/{{ $categories2->slug }}">{{ $categories2->name }}</a>
                                </div>
                                <h3 class="product-title"><a
                                        href="{{ route('user.product_details', ['slug' => $product->slug]) }}">
                                        {{ \Illuminate\Support\Str::substr($product->name, 0, 50) }}
                ...
                <div class="popular-category-slider owl-carousel">
                    ...
                    <div class="slider-item">
                        <div class="product-card">
                            ...
                            <div class="product-card-body">
                                <div class="product-category"><a
                                        href="/shop/category/{{ $categories3->slug }}">{{ $categories3->name }}</a>
                                </div>
                                <h3 class="product-title"><a
                                        href="{{ route('user.product_details', ['slug' => $product->slug]) }}">
                                        {{ \Illuminate\Support\Str::substr($product->name, 0, 50) }}
                ...
                <div class="popular-category-slider owl-carousel">
                    ...
                    <div class="slider-item">
                        <div class="product-card">
                            ...
                            <div class="product-card-body">
                                <div class="product-category"><a
                                        href="/shop/category/{{ $categories4->slug }}">{{ $categories4->name }}</a>
                                </div>
                                <h3 class="product-title"><a
                                        href="{{ route('user.product_details', ['slug' => $product->slug]) }}">
                                        {{ \Illuminate\Support\Str::substr($product->name, 0, 50) }}
